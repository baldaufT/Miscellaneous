...
investedCapital, minBet, strikeInRowNeeded, players, playRounds = 635, 5, 5, 25000, 100

P1 = [Player(investedCapital, minBet) for i in range(players)]
Results, moneyToPlay, gameOver, gameOverQuote, maxStrike, maxLoss, turnover, totalmaxLoss, h1, count = [], 0, 0, 0, 0, 0, 0, 0, players/10, 0
